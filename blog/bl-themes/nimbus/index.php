...
<body class="blog<?php if ($WHERE_AM_I == 'page') { echo '-details'; } ?>-page" data-bs-spy="scroll" data-bs-target="#navmenu">
  ...
  <a href="https://wa.me/554199807930" target="_blank" aria-label="Agendar no WhatsApp" style="
  position: fixed;
  width: 60px;
  height: 60px;
  bottom: 20px;
...
"
  onmouseover="this.style.backgroundColor='#1ebe5d'; this.querySelector('span').style.visibility='visible'; this.querySelector('span').style.opacity='1';"
  onmouseout="this.style.backgroundColor='#25D366'; this.querySelector('span').style.visibility='hidden'; this.querySelector('span').style.opacity='0';"
>
